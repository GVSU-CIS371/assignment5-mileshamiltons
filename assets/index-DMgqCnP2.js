 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FT="firebase-heartbeat-database",UT=1,ci="firebase-heartbeat-store";let ic=null;function zp(){return ic||(ic=nT(FT,UT,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(ci)}catch(t){console.warn(t)}}}}).catch(n=>{throw jn.create("idb-open",{originalErrorMessage:n.message})})),ic}async function BT(n){try{const t=(await zp()).transaction(ci),r=await t.objectStore(ci).get(Wp(n));return await t.done,r}catch(e){if(e instanceof bn)En.warn(e.message);else{const t=jn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});En.warn(t.message)}}}async function Hh(n,e){try{const r=(await zp()).transaction(ci,"readwrite");await r.objectStore(ci).put(e,Wp(n)),await r.done}catch(t){if(t instanceof bn)En.warn(t.message);else{const r=jn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});En.warn(r.message)}}}function Wp(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KT(n){ts(new Tr("platform-logger",e=>new iT(e),"PRIVATE")),ts(new Tr("heartbeat",e=>new qT(e),"PRIVATE")),$n(Pc,$h,n),$n(Pc,$h,"esm2017"),$n("fire-js","")}KT("");function vl(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}function Kp(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const GT=Kp,Gp=new Ti("auth","Firebase",Kp());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const No=new ml("@firebase/auth");function QT(n,...e){No.logLevel<=he.WARN&&No.warn(`Auth (${us}): ${n}`,...e)}function ho(n,...e){No.logLevel<=he.ERROR&&No.error(`Auth (${us}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wi{constructor(e,t){this.shortDelay=e,this.longDelay=t,Tn(t>e,"Short delay should be less than long delay!"),this.isMobile=AE()||PE()}get(){return YT()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function li(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof bn&&aI(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function aI({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xo(n){var e;const t=n.auth,r=await n.getIdToken(),s=await li(n,Oo(t,{idToken:r}));ne(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?Yp(i.providerUserInfo):[],c=uI(n.providerData,a),l=n.isAnonymous,h=!(n.email&&i.passwordHash)&&!(c!=null&&c.length),d=l?h:!1,p={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new Dc(i.createdAt,i.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function lI(n){const e=mt(n);await xo(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function uI(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Yp(n){return n.map(e=>{var{providerId:t}=e,r=vl(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AI(n,e){const t=yl(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Er(i,e??{}))return s;Zt(s,"already-initialized")}return t.initialize({options:e})}function bI(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(dn);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function SI(n,e,t){const r=fa(n);ne(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=lg(e),{host:a,port:c}=RI(e),l=c===null?"":`:${c}`,h={url:`${i}//${a}${l}/`},d=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){ne(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),ne(Er(h,r.config.emulator)&&Er(d,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=d,r.settings.appVerificationDisabledForTesting=!0,ls(a)?(Up(`${i}//${a}${l}`),Bp("Auth",!0)):PI()}function lg(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function RI(n){const e=lg(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Zh(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Zh(a)}}}function Zh(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function PI(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mn extends Ai{constructor(){super("facebook.com")}static credential(e){return Ir._fromParams({providerId:Mn.PROVIDER_ID,signInMethod:Mn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Mn.credentialFromTaggedObject(e)}static credentialFromError(e){return Mn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Mn.credential(e.oauthAccessToken)}catch{return null}}}Mn.FACEBOOK_SIGN_IN_METHOD="facebook.com";Mn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hn extends Ai{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Ir._fromParams({providerId:hn.PROVIDER_ID,signInMethod:hn.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return hn.credentialFromTaggedObject(e)}static credentialFromError(e){return hn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return hn.credential(t,r)}catch{return null}}}hn.GOOGLE_SIGN_IN_METHOD="google.com";hn.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln extends Ai{constructor(){super("github.com")}static credential(e){return Ir._fromParams({providerId:Ln.PROVIDER_ID,signInMethod:Ln.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ln.credentialFromTaggedObject(e)}static credentialFromError(e){return Ln.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ln.credential(e.oauthAccessToken)}catch{return null}}}Ln.GITHUB_SIGN_IN_METHOD="github.com";Ln.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn extends Ai{constructor(){super("twitter.com")}static credential(e,t){return Ir._fromParams({providerId:Fn.PROVIDER_ID,signInMethod:Fn.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Fn.credentialFromTaggedObject(e)}static credentialFromError(e){return Fn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return Fn.credential(t,r)}catch{return null}}}Fn.TWITTER_SIGN_IN_METHOD="twitter.com";Fn.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ui=-1;function dA(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=se.fromTimestamp(r===1e9?new ke(t+1,0):new ke(t,r));return new Gn(s,X.empty(),e)}function pA(n){return new Gn(n.readTime,n.key,ui)}class Gn{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new Gn(se.min(),X.empty(),ui)}static max(){return new Gn(se.max(),X.empty(),ui)}}function gA(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=X.comparator(n.documentKey,e.documentKey),t!==0?t:ue(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Og="";function EA(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Tf(e)),e=TA(n.get(t),e);return Tf(e)}function TA(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case Og:t+="";break;default:t+=i}}return t}function Tf(n){return n+Og+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lg="server_timestamp",Fg="__type__",Ug="__previous_value__",Bg="__local_write_time__";function Nl(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{})[Fg])===null||t===void 0?void 0:t.stringValue)===Lg}function ya(n){const e=n.mapValue.fields[Ug];return Nl(e)?ya(e):e}function hi(n){const e=Qn(n.mapValue.fields[Bg].timestampValue);return new ke(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jA=new Oe(X.comparator);function wn(){return jA}const Zg=new Oe(X.comparator);function Us(...n){let e=Zg;for(const t of n)e=e.insert(t.key,t);return e}function em(n){let e=Zg;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function pr(){return ei()}function tm(){return ei()}function ei(){return new Pr((n=>n.toString()),((n,e)=>n.isEqual(e)))}const $A=new Oe(X.comparator),qA=new Ke(X.comparator);function fe(...n){let e=qA;for(const t of n)e=e.add(t);return e}const HA=new Ke(ue);function zA(){return HA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fl(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Uo(e)?"-0":e}}function nm(n){return{integerValue:""+n}}function WA(n,e){return vA(e)?nm(e):Fl(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wa{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Ci.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new wa(se.min(),s,new Oe(ue),wn(),fe())}}class Ci{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Ci(r,t,fe(),fe(),fe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Db{constructor(){this.changes=new Pr((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ct.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?D.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ob{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next((s=>(r=s,this.remoteDocumentCache.getEntry(e,t)))).next((s=>(r!==null&&ti(r.mutation,s,Dt.empty(),ke.now()),s)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((r=>this.getLocalViewOfDocuments(e,r,fe()).next((()=>r))))}getLocalViewOfDocuments(e,t,r=fe()){const s=pr();return this.populateOverlays(e,s,t).next((()=>this.computeViews(e,t,s,r).next((i=>{let a=Us();return i.forEach(((c,l)=>{a=a.insert(c,l.overlayedDocument)})),a}))))}getOverlayedDocuments(e,t){const r=pr();return this.populateOverlays(e,r,t).next((()=>this.computeViews(e,t,r,fe())))}populateOverlays(e,t,r){const s=[];return r.forEach((i=>{t.has(i)||s.push(i)})),this.documentOverlayCache.getOverlays(e,s).next((i=>{i.forEach(((a,c)=>{t.set(a,c)}))}))}computeViews(e,t,r,s){let i=wn();const a=ei(),c=(function(){return ei()})();return t.forEach(((l,h)=>{const d=r.get(h.key);s.has(h.key)&&(d===void 0||d.mutation instanceof Cr)?i=i.insert(h.key,h):d!==void 0?(a.set(h.key,d.mutation.getFieldMask()),ti(d.mutation,h,d.mutation.getFieldMask(),ke.now())):a.set(h.key,Dt.empty())})),this.recalculateAndSaveOverlays(e,i).next((l=>(l.forEach(((h,d)=>a.set(h,d))),t.forEach(((h,d)=>{var p;return c.set(h,new Nb(d,(p=a.get(h))!==null&&p!==void 0?p:null))})),c)))}recalculateAndSaveOverlays(e,t){const r=ei();let s=new Oe(((a,c)=>a-c)),i=fe();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((a=>{for(const c of a)c.keys().forEach((l=>{const h=t.get(l);if(h===null)return;let d=r.get(l)||Dt.empty();d=c.applyToLocalView(h,d),r.set(l,d);const p=(s.get(c.batchId)||fe()).add(l);s=s.insert(c.batchId,p)}))})).next((()=>{const a=[],c=s.getReverseIterator();for(;c.hasNext();){const l=c.getNext(),h=l.key,d=l.value,p=tm();d.forEach((_=>{if(!i.has(_)){const b=am(t.get(_),r.get(_));b!==null&&p.set(_,b),i=i.add(_)}})),a.push(this.documentOverlayCache.saveOverlays(e,h,p))}return D.waitFor(a)})).next((()=>r))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((r=>this.recalculateAndSaveOverlays(e,r)))}getDocumentsMatchingQuery(e,t,r,s){return(function(a){return X.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0})(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Jg(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next((i=>{const a=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-i.size):D.resolve(pr());let c=ui,l=i;return a.next((h=>D.forEach(h,((d,p)=>(c<p.largestBatchId&&(c=p.largestBatchId),i.get(d)?D.resolve():this.remoteDocumentCache.getEntry(e,d).next((_=>{l=l.insert(d,_)}))))).next((()=>this.populateOverlays(e,h,i))).next((()=>this.computeViews(e,l,h,fe()))).next((d=>({batchId:c,changes:em(d)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new X(t)).next((r=>{let s=Us();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s}))}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const i=t.collectionGroup;let a=Us();return this.indexManager.getCollectionParents(e,i).next((c=>D.forEach(c,(l=>{const h=(function(p,_){return new Ri(_,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)})(t,l.child(i));return this.getDocumentsMatchingCollectionQuery(e,h,r,s).next((d=>{d.forEach(((p,_)=>{a=a.insert(p,_)}))}))})).next((()=>a))))}getDocumentsMatchingCollectionQuery(e,t,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next((a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,i,s)))).next((a=>{i.forEach(((l,h)=>{const d=h.getKey();a.get(d)===null&&(a=a.insert(d,ct.newInvalidDocument(d)))}));let c=Us();return a.forEach(((l,h)=>{const d=i.get(l);d!==void 0&&ti(d.mutation,h,Dt.empty(),ke.now()),Ea(t,h)&&(c=c.insert(l,h))})),c}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ar="RemoteStore";class h0{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=i,this.Ea.xo((a=>{r.enqueueAndForget((async()=>{Vr(this)&&(W(Ar,"Restarting streams for network reachability change."),await(async function(l){const h=ie(l);h.Ia.add(4),await Vi(h),h.Aa.set("Unknown"),h.Ia.delete(4),await ba(h)})(this))}))})),this.Aa=new u0(r,s)}}async function ba(n){if(Vr(n))for(const e of n.da)await e(!0)}async function Vi(n){for(const e of n.da)await e(!1)}function Sm(n,e){const t=ie(n);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),Ql(t)?Gl(t):gs(t).x_()&&Kl(t,e))}function Wl(n,e){const t=ie(n),r=gs(t);t.Ta.delete(e),r.x_()&&Rm(t,e),t.Ta.size===0&&(r.x_()?r.B_():Vr(t)&&t.Aa.set("Unknown"))}function Kl(n,e){if(n.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(se.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}gs(n).H_(e)}function Rm(n,e){n.Ra.$e(e),gs(n).Y_(e)}function Gl(n){n.Ra=new ib({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>n.Ta.get(e)||null,lt:()=>n.datastore.serializer.databaseId}),gs(n).start(),n.Aa.aa()}function Ql(n){return Vr(n)&&!gs(n).M_()&&n.Ta.size>0}function Vr(n){return ie(n).Ia.size===0}function Pm(n){n.Ra=void 0}async function f0(n){n.Aa.set("Online")}async function d0(n){n.Ta.forEach(((e,t)=>{Kl(n,e)}))}async function p0(n,e){Pm(n),Ql(n)?(n.Aa.la(e),Gl(n)):n.Aa.set("Unknown")}async function g0(n,e,t){if(n.Aa.set("Online"),e instanceof fm&&e.state===2&&e.cause)try{await(async function(s,i){const a=i.cause;for(const c of i.targetIds)s.Ta.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.Ta.delete(c),s.Ra.removeTarget(c))})(n,e)}catch(r){W(Ar,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Go(n,r)}else if(e instanceof Eo?n.Ra.Ye(e):e instanceof hm?n.Ra.it(e):n.Ra.et(e),!t.isEqual(se.min()))try{const r=await wm(n.localStore);t.compareTo(r)>=0&&await(function(i,a){const c=i.Ra.Pt(a);return c.targetChanges.forEach(((l,h)=>{if(l.resumeToken.approximateByteSize()>0){const d=i.Ta.get(h);d&&i.Ta.set(h,d.withResumeToken(l.resumeToken,a))}})),c.targetMismatches.forEach(((l,h)=>{const d=i.Ta.get(l);if(!d)return;i.Ta.set(l,d.withResumeToken(et.EMPTY_BYTE_STRING,d.snapshotVersion)),Rm(i,l);const p=new Un(d.target,l,h,d.sequenceNumber);Kl(i,p)})),i.remoteSyncer.applyRemoteEvent(c)})(n,t)}catch(r){W(Ar,"Failed to raise snapshot:",r),await Go(n,r)}}async function Go(n,e,t){if(!ps(e))throw e;n.Ia.add(1),await Vi(n),n.Aa.set("Offline"),t||(t=()=>wm(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{W(Ar,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await ba(n)}))}function Cm(n,e){return e().catch((t=>Go(n,t,e)))}async function Sa(n){const e=ie(n),t=Yn(e);let r=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:Dl;for(;m0(e);)try{const s=await Xb(e.localStore,r);if(s===null){e.Pa.length===0&&t.B_();break}r=s.batchId,_0(e,s)}catch(s){await Go(e,s)}Vm(e)&&km(e)}function m0(n){return Vr(n)&&n.Pa.length<10}function _0(n,e){n.Pa.push(e);const t=Yn(n);t.x_()&&t.Z_&&t.X_(e.mutations)}function Vm(n){return Vr(n)&&!Yn(n).M_()&&n.Pa.length>0}function km(n){Yn(n).start()}async function y0(n){Yn(n).na()}async function v0(n){const e=Yn(n);for(const t of n.Pa)e.X_(t.mutations)}async function E0(n,e,t){const r=n.Pa.shift(),s=Ul.from(r,e,t);await Cm(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await Sa(n)}async function T0(n,e){e&&Yn(n).Z_&&await(async function(r,s){if((function(a){return rb(a)&&a!==k.ABORTED})(s.code)){const i=r.Pa.shift();Yn(r).N_(),await Cm(r,(()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s))),await Sa(r)}})(n,e),Vm(n)&&km(n)}async function Jf(n,e){const t=ie(n);t.asyncQueue.verifyOperationInProgress(),W(Ar,"RemoteStore received new credentials");const r=Vr(t);t.Ia.add(3),await Vi(t),r&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await ba(t)}async function I0(n,e){const t=ie(n);e?(t.Ia.delete(2),await ba(t)):e||(t.Ia.add(2),await Vi(t),t.Aa.set("Unknown"))}function gs(n){return n.Va||(n.Va=(function(t,r,s){const i=ie(t);return i.ia(),new o0(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:f0.bind(null,n),e_:d0.bind(null,n),n_:p0.bind(null,n),J_:g0.bind(null,n)}),n.da.push((async e=>{e?(n.Va.N_(),Ql(n)?Gl(n):n.Aa.set("Unknown")):(await n.Va.stop(),Pm(n))}))),n.Va}function Yn(n){return n.ma||(n.ma=(function(t,r,s){const i=ie(t);return i.ia(),new a0(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),e_:y0.bind(null,n),n_:T0.bind(null,n),ea:v0.bind(null,n),ta:E0.bind(null,n)}),n.da.push((async e=>{e?(n.ma.N_(),await Sa(n)):(await n.ma.stop(),n.Pa.length>0&&(W(Ar,`Stopping write stream with ${n.Pa.length} pending writes`),n.Pa=[]))}))),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */$n(yS,vS,"app");const ES={apiKey:"AIzaSyCs0ZzdWLEyLE2Cdclo1pUR4ErJ77CQ_AE",authDomain:"proj4-aca0c.firebaseapp.com",projectId:"proj4-aca0c",storageBucket:"proj4-aca0c.firebasestorage.app",messagingSenderId:"235290959979",appId:"1:235290959979:web:a6cf88f7f0c71e52f5912e",measurementId:"G-KNRRKBGVHC"},r_=qp(ES),xs=X0(r_),dc=Kw(r_),TS=new hn,ms=iE("BeverageStore",{state:()=>({temps:fd,currentTemp:fd[0],bases:[],currentBase:null,syrups:[],currentSyrup:null,creamers:[],currentCreamer:null,beverages:[],currentBeverage:null,currentName:"",user:null,unsubscribeBeverages:null}),actions:{async init(){const[n,e,t]=await Promise.all([fc(io(xs,"bases")),fc(io(xs,"creamers")),fc(io(xs,"syrups"))]);this.bases=n.docs.map(r=>r.data()),this.creamers=e.docs.map(r=>r.data()),this.syrups=t.docs.map(r=>r.data()),this.currentBase=this.bases[0]??null,this.currentCreamer=this.creamers[0]??null,this.currentSyrup=this.syrups[0]??null},setUser(n){if(this.user=n,this.unsubscribeBeverages&&(this.unsubscribeBeverages(),this.unsubscribeBeverages=null),!n){this.beverages=[],this.currentBeverage=null;return}const e=lS(io(xs,"beverages"),uS("userId","==",n.uid));this.unsubscribeBeverages=gS(e,t=>{if(this.beverages=t.docs.map(r=>r.data()),this.beverages.length===0){this.currentBeverage=null;return}if(this.currentBeverage){const r=this.beverages.find(s=>{var i;return s.id===((i=this.currentBeverage)==null?void 0:i.id)});this.currentBeverage=r??this.beverages[0]}else this.currentBeverage=this.beverages[0]})},async makeBeverage(){if(!this.user)return"No user logged in, please sign in first.";if(!this.currentName.trim()||!this.currentBase||!this.currentCreamer||!this.currentSyrup||!this.currentTemp)return"Please complete all beverage options and the name before making a beverage.";const n=`bev-${this.user.uid}-${Date.now()}`,e={id:n,name:this.currentName.trim(),temp:this.currentTemp,base:this.currentBase,creamer:this.currentCreamer,syrup:this.currentSyrup,userId:this.user.uid,userName:this.user.displayName||this.user.email||"Unknown User",createdAt:Date.now()};return await pS(J0(xs,"beverages",n),e),this.currentBeverage=e,this.currentName="",`Beverage ${e.name} made successfully!`},showBeverage(n){const e=this.beverages.find(t=>t.id===n)??null;this.currentBeverage=e,e&&(this.currentTemp=e.temp,this.currentBase=e.base,this.currentCreamer=e.creamer,this.currentSyrup=e.syrup,this.currentName=e.name)}}}),IS=vi({__name:"Syrup",setup(n){const e=ms();return(t,r)=>{var s;return de(),Se("div",{class:"syrup",style:cs({"--texture-color":(s=_e(e).currentSyrup)==null?void 0:s.color})},null,4)}}}),wS=Sr(IS,[["__scopeId","data-v-2fa3a41a"]]),AS=vi({__name:"Base",setup(n){const e=ms();return(t,r)=>{var s;return de(),Se("div",{class:"baseBeverage",style:cs({backgroundColor:(s=_e(e).currentBase)==null?void 0:s.color})},null,4)}}}),bS=Sr(AS,[["__scopeId","data-v-8cc1f7b4"]]),SS={class:"froth"},RS=vi({__name:"Creamer",setup(n){const e=ms();return(t,r)=>(de(),Se("div",SS,[(de(),Se(Fe,null,On(5,()=>{var s;return Te("div",{class:"foam",style:cs({backgroundColor:(s=_e(e).currentCreamer)==null?void 0:s.color})},null,4)}),64))]))}}),PS=Sr(RS,[["__scopeId","data-v-84d3ef89"]]),CS={},VS={id:"steam"},kS={class:"stream"};function DS(n,e){return de(),Se("div",VS,[(de(),Se(Fe,null,On(3,()=>Te("div",kS)),64))])}const NS=Sr(CS,[["render",DS]]),OS={},xS={id:"condensation"},MS={class:"flake"};function LS(n,e){return de(),Se("div",xS,[(de(),Se(Fe,null,On(3,()=>Te("div",MS)),64))])}const FS=Sr(OS,[["render",LS]]),US=vi({__name:"Beverage",props:{isIced:{type:Boolean}},setup(n){const e=ms();return(t,r)=>(de(),xn(nA,null,{default:Ms(()=>[n.isIced?(de(),xn(FS,{key:0})):(de(),xn(NS,{key:1})),It(Yw,null,{top:Ms(()=>{var s;return[((s=_e(e).currentCreamer)==null?void 0:s.color)!=="transparent"?(de(),xn(PS,{key:0})):Po("",!0)]}),mid:Ms(()=>{var s;return[((s=_e(e).currentSyrup)==null?void 0:s.color)!=="transparent"?(de(),xn(wS,{key:0})):Po("",!0)]}),bottom:Ms(()=>[It(bS)]),_:1})]),_:1}))}}),BS={class:"page"},jS={class:"auth-section"},$S={key:0},qS={key:1},HS={key:0,class:"message"},zS=["id","value"],WS=["id","value"],KS=["id","value"],GS=["id","value"],QS={class:"name-section"},JS=["disabled"],XS={key:1,class:"saved-section"},YS=["value","checked","onChange"],ZS=vi({__name:"App",setup(n){const e=ms(),t=Bd(""),r=async()=>{t.value="";try{await nw(dc,TS)}catch(a){a instanceof Error?t.value=a.message:t.value="Google sign-in failed."}},s=async()=>{t.value="";try{await MI(dc),t.value="Signed out successfully."}catch(a){a instanceof Error?t.value=a.message:t.value="Sign out failed."}},i=async()=>{t.value=await e.makeBeverage()};return Zd(()=>{xI(dc,a=>{e.setUser(a)})}),(a,c)=>(de(),Se(Fe,null,[Te("div",BS,[Te("div",jS,[_e(e).user?(de(),Se("p",$S,[c[5]||(c[5]=ur(" Signed in as: ",-1)),Te("strong",null,kn(_e(e).user.displayName||_e(e).user.email),1)])):(de(),Se("p",qS,"Not signed in")),_e(e).user?(de(),Se("button",{key:3,onClick:s},"Sign out")):(de(),Se("button",{key:2,onClick:r}," Sign in with Google "))]),t.value?(de(),Se("p",HS,kn(t.value),1)):Po("",!0),It(US,{isIced:_e(e).currentTemp==="Cold"},null,8,["isIced"]),Te("ul",null,[Te("li",null,[c[6]||(c[6]=Te("h3",null,"Temperature",-1)),(de(!0),Se(Fe,null,On(_e(e).temps,l=>(de(),Se("label",{key:l},[Ns(Te("input",{type:"radio",name:"temperature",id:`r${l}`,value:l,"onUpdate:modelValue":c[0]||(c[0]=h=>_e(e).currentTemp=h)},null,8,zS),[[Yi,_e(e).currentTemp]]),ur(" "+kn(l),1)]))),128))])]),Te("ul",null,[Te("li",null,[c[7]||(c[7]=Te("h3",null,"Base",-1)),(de(!0),Se(Fe,null,On(_e(e).bases,l=>(de(),Se("label",{key:l.id},[Ns(Te("input",{type:"radio",name:"bases",id:`r${l.id}`,value:l,"onUpdate:modelValue":c[1]||(c[1]=h=>_e(e).currentBase=h)},null,8,WS),[[Yi,_e(e).currentBase]]),ur(" "+kn(l.name),1)]))),128))])]),Te("ul",null,[Te("li",null,[c[8]||(c[8]=Te("h3",null,"Syrup",-1)),(de(!0),Se(Fe,null,On(_e(e).syrups,l=>(de(),Se("label",{key:l.id},[Ns(Te("input",{type:"radio",name:"syrups",id:`r${l.id}`,value:l,"onUpdate:modelValue":c[2]||(c[2]=h=>_e(e).currentSyrup=h)},null,8,KS),[[Yi,_e(e).currentSyrup]]),ur(" "+kn(l.name),1)]))),128))])]),Te("ul",null,[Te("li",null,[c[9]||(c[9]=Te("h3",null,"Creamer",-1)),(de(!0),Se(Fe,null,On(_e(e).creamers,l=>(de(),Se("label",{key:l.id},[Ns(Te("input",{type:"radio",name:"creamers",id:`r${l.id}`,value:l,"onUpdate:modelValue":c[3]||(c[3]=h=>_e(e).currentCreamer=h)},null,8,GS),[[Yi,_e(e).currentCreamer]]),ur(" "+kn(l.name),1)]))),128))])]),Te("div",QS,[Ns(Te("input",{type:"text",placeholder:"Beverage Name","onUpdate:modelValue":c[4]||(c[4]=l=>_e(e).currentName=l)},null,512),[[Wv,_e(e).currentName]]),Te("button",{onClick:i,disabled:!_e(e).user}," 🍺 Make Beverage ",8,JS)]),_e(e).user&&_e(e).beverages.length>0?(de(),Se("div",XS,[c[10]||(c[10]=Te("h3",null,"Saved Beverages",-1)),(de(!0),Se(Fe,null,On(_e(e).beverages,l=>{var h;return de(),Se("label",{key:l.id},[Te("input",{type:"radio",name:"savedBeverages",value:l.id,checked:((h=_e(e).currentBeverage)==null?void 0:h.id)===l.id,onChange:d=>_e(e).showBeverage(l.id)},null,40,YS),ur(" "+kn(l.name),1)])}),128))])):Po("",!0)]),c[11]||(c[11]=Te("div",{id:"beverage-container",style:{"margin-top":"20px"}},null,-1))],64))}}),s_=Jv(ZS),i_=Zv();i_.use(uE);s_.use(i_);async function eR(){await ms().init(),s_.mount("#app")}eR();
